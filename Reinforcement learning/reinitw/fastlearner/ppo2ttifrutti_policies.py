...
class filmInit(object):
    ...
    def reinit(self):
        self.sess.run(tf.variables_initializer([self.film_w_1, self.film_b_1, self.film_w_2, self.film_b_2, self.film_w_3, self.film_b_3]))
...
class CnnPolicy(object):
    ...
    def __init__(self, sess, ob_space, ac_space, nbatch, nsteps, filmObj, reuse=False,st = "act", **conv_kwargs): #pylint: disable=W0613
        ...
        ob_shape = (None, nh, nw, nc) # Use this
