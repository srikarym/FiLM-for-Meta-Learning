...
flags.DEFINE_integer('sigma_dim',8,'dimension of sigma used in hidden')
...
def main():
	...
	if FLAGS.resume or not FLAGS.train:
		...
		if model_file:
			model_file = "logs/omniglot5way/cls_5.mbs_32.ubs_1.numstep1.updatelr0.4batchnorm/model37000"
