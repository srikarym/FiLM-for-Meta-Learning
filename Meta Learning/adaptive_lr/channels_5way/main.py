...
flags.DEFINE_bool('stop_grad', False, 'if True, do not use second derivatives in meta-optimization (for speed)') #Changed from false to true
...
def main():
    ...
    if FLAGS.resume or not FLAGS.train:
        ...
        if model_file:
            model_file = "logs/omniglot5way/cls_5.mbs_32.ubs_1.numstep1.updatelr0.4batchnorm/model31000"
